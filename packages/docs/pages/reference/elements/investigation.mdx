...
The `<investigation>` tag, together with [`<project>`](./project.mdx), [`<activity>`](./activity.mdx), 
...
<FRAGMENT parents="subsection section">
    <investigation><title>Differentiating polynomials</title>
        <p>
...
```ptx-example
<FRAGMENT parents="subsection section">
    <investigation><title>A highly structured investigation</title>
        <introduction>
            <p>
