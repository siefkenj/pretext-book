// NOTE: importing from `nextra/components` doesn't seem to work, so we copy the file contents here
// https://github.com/shuding/nextra/blob/v3/packages/nextra/src/client/components/cards.tsx
// 2024-07-11
