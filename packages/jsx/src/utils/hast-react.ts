...
import {
    ...
    Text as XMLText,
    Comment as XMLComment,
    Doctype as XMLDoctype,
    Instruction as XMLInstruction,
    Cdata as XMLCdata,
} from "xast";
 ...
 *
 */
export const xastReactTransformer: Plugin<
...
> = function (options) {
     ...
     */
    function h(node: XMLElement, key: number, file: VFile): [React.ReactNode] {
        ...
        const origProps = node.attributes || {};
