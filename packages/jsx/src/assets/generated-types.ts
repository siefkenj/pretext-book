...
export interface ElementLatexImagePreamble
...
export interface ElementShortdescription
    extends Omit<XMLElement, "attributes"> {
...
export interface ElementShortdescription1
    extends Omit<XMLElement, "attributes"> {
    name: "shortdescription";
...
export interface ElementShortdescription2
    extends Omit<XMLElement, "attributes"> {
    name: "shortdescription";
    children: (ElementWWVariable | XMLText)[];
}
